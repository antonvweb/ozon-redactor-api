...
import org.ozonLabel.user.repository.CompanyAuditLogRepository;
...
@Slf4j
public class AuditLogServiceIml implements AuditLogService {
     ...
     */
    @Transactional
    public void logAction(Long companyOwnerId, Long userId, AuditAction action,
    ...
    @Override
    public Long countUserActions(Long companyOwnerId, Long userId) {
        return auditLogRepository.countByCompanyOwnerIdAndUserId(companyOwnerId, userId);
    }

    @Override
    public AuditLogResponseDto getCompanyAuditLogByDateRange(String userEmail, Long companyOwnerId,
        ...
        Pageable pageable = PageRequest.of(page, size);
        Page<CompanyAuditLog> logPage = auditLogRepository.findByCompanyOwnerIdAndDateRange(
                companyOwnerId, startDate, endDate, pageable
        );
    ...
    @Override
    public AuditLogResponseDto getCompanyAuditLogByAction(String userEmail, Long companyOwnerId,
        ...
        Pageable pageable = PageRequest.of(page, size);
        Page<CompanyAuditLog> logPage = auditLogRepository.findByCompanyOwnerIdAndActionOrderByCreatedAtDesc(
                companyOwnerId, action, pageable
        );
